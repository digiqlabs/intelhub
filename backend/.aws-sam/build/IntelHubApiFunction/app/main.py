...
DEFAULT_ALLOWED_ORIGIN_REGEX = r"https?://(localhost|127\.0\.0\.1)(:\\d+)?$"
...
_env_origins.extend(_split_env_list(os.getenv("ALLOWED_ORIGINS")))
_env_origins.extend(_split_env_list(os.getenv("FRONTEND_BASE_URL")))
_env_origins.extend(_split_env_list(os.getenv("ADDITIONAL_ALLOWED_ORIGINS")))

ALLOWED_ORIGINS = _dedupe([*DEFAULT_ALLOWED_ORIGINS, *_env_origins])


def _env_or_default(variable: str, default: str) -> str:
...
ALLOWED_ORIGIN_REGEX = _env_or_default("ALLOWED_ORIGIN_REGEX", DEFAULT_ALLOWED_ORIGIN_REGEX)
